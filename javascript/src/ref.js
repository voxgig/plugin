 ...
 * none — the TOLERANT half of `canonref`, and the one a requirement name
 * needs.
 *
 ...
 * document kill the host. Answering `undefined` is the whole difference. */
function tryref(str) {
...
module.exports = { checkname, checktag, parseref, formatref, canonref, tryref }
