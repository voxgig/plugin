...
export function makehost(options?: HostOptions) {
  ...
  function reconcile(): void {
    ...
    while (moved) {
      ...
      // longer a candidate would go stale, so reads would answer the
      // new winner while the record still named the old one, and a
      ...
      // callback or its signature. Recorded in doc/plan/status.md as an
      // open model question rather than invented here.
  ...
  function selectedof(ref: string, name: string): string | null {
